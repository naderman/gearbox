...
class URG_NZ_EXPORT URGLaser
{
	public:
		...
		unsigned int GetRanges (URGData *data, int startStep = -1, int endStep = -1,
		...
		minimum value from a cluster is returned as the range for that cluster.
		@return The number of range readings read into @ref data. */
		unsigned int GetRanges (URGData *data, double startAngle, double endAngle,
								unsigned int clusterCount = 1);
		...
		@param endStep The last step to get ranges from. Set to -1 for the last scannable step.
		@return The number of range readings read into @ref data. */
		unsigned int GetNewRanges (URGData *data, int startStep = -1, int endStep = -1,
								unsigned int clusterCount = 1);
		...
		minimum value from a cluster is returned as the range for that cluster.
		@return The number of range readings read into @ref data. */
		unsigned int GetNewRanges (URGData *data, double startAngle, double endAngle,
								unsigned int clusterCount = 1);
	...
	private:
		...
		void Read2ByteRangeData (URGData *data, unsigned int numSteps);
		void Read3ByteRangeData (URGData *data, unsigned int numSteps);
};
